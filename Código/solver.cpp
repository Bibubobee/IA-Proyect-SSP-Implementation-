...
void read_instance(){
    ...
    S_d_t.resize(h, vector<int>(CT, 0)); // Employees required for day t
    OS_d_t.resize(h, vector<int>(CT, 0)); // Over Staffing penalty
    US_d_t.resize(h, vector<int>(CT, 0)); // Under Staffing penalty
